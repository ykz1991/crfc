...
segLens = [120]  # [40, 80, 120, 160, 200]            # 40 samples/10 seconds per segment
fhr = np.load('../../data/simulated/artificial_u.npy')
...
for segLen in segLens:
    ...
    np.save('./feature/feats_time_freq_%d_unhealthy.npy' % segLen, feat_vector)
